...
// // app.use(cors({ origin: "http://localhost:3000" })); // Update if frontend runs on a different port
...
// //   try {
// //     console.log("Incoming Student Data:", req.body); // Log request data
...
//   try {
//     const students = await Student.find(); // Assuming `Student` is your MongoDB model
...
//         gpa,
//         scores: student.scores, // Ensure scores are included here
//       };
//     });
